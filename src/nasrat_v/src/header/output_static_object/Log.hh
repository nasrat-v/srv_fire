...
public:
    ...
    enum    debugMode
    {
        ...
        ENTITIES = 0b0000'0000'0001'0000,
        DIFFERENCE = 0b0000'0000'0010'0000,
        TRACK = 0b0000'0000'0100'0000,
        NUMBER = 0b0000'0000'1000'0000,
        WAIT_KEY = 0b0000'0001'0000'0000,
        NO_ORIGINAL_VIDEO = 0b0000'0010'0000'0000,
